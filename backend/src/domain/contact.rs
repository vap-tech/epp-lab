...
impl ContactStatus {
    ...
    pub fn parse(value: &str) -> Option<Self> {
        match value {
            ...
            "serverDeleteProhibited" => Some(Self::ServerDeleteProhibited),
            "serverTransferProhibited" => Some(Self::ServerTransferProhibited),
            "serverUpdateProhibited" => Some(Self::ServerUpdateProhibited),
