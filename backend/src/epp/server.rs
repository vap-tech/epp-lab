            ...
            match parsed {
                Ok(parsed) => match parsed.command {
                    ...
                    crate::epp::parser::EppCommand::Domain(
                        crate::epp::parser::DomainCommand::Check(command),
                    ) => {
                        response = Some(
                            crate::epp::dispatch::execute_domain_check(
                                &mut stream,
                                &limits,
                                &db,
                                transaction_id,
                    ...
                    crate::epp::parser::EppCommand::Domain(
                        crate::epp::parser::DomainCommand::Create(command),
                    ) => {
                        response = Some(
                            crate::epp::dispatch::execute_domain_create(
                                &mut stream,
                                &limits,
                                &db,
                                transaction_id,
                    ...
                    crate::epp::parser::EppCommand::Domain(
                        crate::epp::parser::DomainCommand::Info(command),
                    ) => {
                        response = Some(
                            crate::epp::dispatch::execute_domain_info(
                                &mut stream,
                                &limits,
                                &db,
                                transaction_id,
